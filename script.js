        ...
        <div class="col-md-6">
            <div class="card-body">
                ...
                <ul class="ps-0 list-inline mb-0">
                    <li class=" list-inline-item"> <span class=""><i class="fa-solid fa-circle icon-size primary-color"></span></i> ${details.mainFeatures.sensors[0]?details.mainFeatures.sensors[0]:""}</li>
                    <li class=" list-inline-item"> <span class=""><i class="fa-solid fa-circle icon-size primary-color"></span></i> ${details.mainFeatures.sensors[1]?details.mainFeatures.sensors[1]:""}</li>
                    <li class=" list-inline-item"> <span class=""><i class="fa-solid fa-circle icon-size primary-color"></span></i> ${details.mainFeatures.sensors[2]?details.mainFeatures.sensors[2]:""}</li>.
                    <li class=" list-inline-item"> <span class=""><i class="fa-solid fa-circle icon-size primary-color"></span></i> ${details.mainFeatures.sensors[3]?details.mainFeatures.sensors[3]:""}</li>
                    <li class=" list-inline-item"> <span class=""><i class="fa-solid fa-circle icon-size primary-color"></span></i> ${details.mainFeatures.sensors[4]?details.mainFeatures.sensors[4]:""}</li>
                    <li class=" list-inline-item"> <span class=""><i class="fa-solid fa-circle icon-size primary-color"></span></i> ${details.mainFeatures.sensors[5]?details.mainFeatures.sensors[5]:""}</li>
                </ul>
            </div>
        </div>
            <div class="col-md-4">
